...
//////////////////////////////////////////////ТУТ СМОТРЮ ПАДАЮТ ЛИ В ОЧЕРЕДЬ ТРЕКИ////////////////////////////////////////
...
{		
		...
		{	
			console.log(i + ". " + queue[i]["title"] + "\" (requested by " + queue[i]["user"] + ")\n");		
		}	
}

// Тут вся жара происходит
function play_next_song() {
	...
	console.log("now play: https://www.youtube.com/watch?v=" + video_id);	
	voice_handler = voice_connection.playStream(audio_stream/*,{ seek : 0, volume : 1}*/);
...
exports.run = function(server_name, text_channel_name, voice_channel_name, aliases_path, token) {
	...
	bot.on("ready", () => {
		...
		voice_channel.join().then(connection => {
			...
			//Radio Ultra
			bot.user.setActivity("Radio Ultra");                   
			const dispatcher = connection.playArbitraryInput('https://nashe1.hostingradio.ru:18000/ultra-128.mp3',{seek : 0, volume : 0.1, bitrate : 128});
			//Radio Ultra
			}).catch(console.error);
